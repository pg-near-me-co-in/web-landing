...
export type Database = {
  ...
  public: {
    Tables: {
      ...
      listings: {
        Row: {
          ...
          house_rules: Database["public"]["Enums"]["house_rules"]
          id: string
          images: Json
          ...
          locality: string
          name: string
          pg_gender: Database["public"]["Enums"]["pg_gender"]
          price_max: number
          price_min: number
          road_access: boolean
    ...
    Enums: {
      ...
      listing_status: "pending" | "published" | "rejected" | "archived"
