...
import { OWNER_BENEFITS, OWNER_FAQS } from "@/lib/content";
      ...
      <div className="mx-auto max-w-3xl px-4 py-14 sm:px-6 sm:py-20">
        ...
        <div className="mt-9 grid gap-3.5">
          {OWNER_BENEFITS.map((point) => (
            <div key={point} className="flex items-start gap-3 rounded-xl border border-grey-50 bg-white p-4 shadow-card">
              <span className="mt-0.5 grid h-5 w-5 shrink-0 place-items-center rounded-full bg-success-bg text-success-fg">✓</span>
        ...
        <div className="mt-9">
          <Link href="/add-your-pg" className="inline-flex h-12 items-center gap-2 rounded-xl bg-primary px-6 text-sm font-semibold text-white shadow-elevated transition hover:bg-primary-dark">
            Submit your PG →
          </Link>
        </div>
